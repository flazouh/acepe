...
pub mod session_transcript_snapshot;
pub mod skill;
...
pub use session_thread_snapshot::Entity as SessionThreadSnapshot;
pub use session_transcript_snapshot::Entity as SessionTranscriptSnapshot;
