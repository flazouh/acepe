...
use crate::acp::client::claude_client::permissions::{
    allow_permission_result, auto_accept_reason, build_denied_hook_output,
    build_permission_patterns, build_permission_request_update,
    build_reusable_permission_approval_entries, build_reusable_permission_key,
    parse_permission_suggestions, response_outcome_allows, selected_option_id,
...
use crate::acp::client::claude_client::questions::{
    ...
    has_pending_stream_only_question, question_answers_are_empty,
    should_suppress_update_while_awaiting_stream_only_question, take_stream_only_question_state,
    wait_for_question_request_binding, PendingQuestionState,
};
use crate::acp::client::claude_client::streaming::{
    clear_pending_approval_callback_diagnostic_for_terminal_update,
    collect_cc_sdk_updates_for_dispatch, dispatch_cc_sdk_update, provider_session_id_from_message,
    run_streaming_bridge, ApprovalCallbackTracker, StreamingBridgeContext, ToolCallIdTracker,
};
...
use crate::acp::session_update::{
    ...
    ToolCallUpdateData, ToolReference,
};
...
impl cc_sdk::CanUseTool for AcepePermissionHandler {
    async fn can_use_tool(
        ...
        let auto_accept_reason = auto_accept_reason(
            &self.session_id,
            self.agent_type,
            &self.session_policy,
