...
pub async fn acp_new_session(
    ...
    // Track session creation with agent type
    analytics::track_event(
        app.clone(),
        AnalyticsEvent::SessionCreated,
        Some(json!({"agent_type": agent_id_enum.as_str()})),
    );
