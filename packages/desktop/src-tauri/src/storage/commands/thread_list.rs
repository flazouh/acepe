...
pub async fn save_thread_list_settings(
    ...
    unexpected_command_result("save_thread_list_settings", "Failed to save thread list settings", async {
...
#[tauri::command]
#[specta::specta]
pub async fn get_thread_list_settings(app: AppHandle) -> CommandResult<ThreadListSettings>  {
    unexpected_command_result("get_thread_list_settings", "Failed to get thread list settings", async {
