...
import { rowsFromProjectedMessages, type TranscriptViewportRow } from "@acepe/transcript-viewport";
...
export const transcriptRowsFromSessionSnapshot = (
	snapshot: RpcSessionSnapshot
): ReadonlyArray<TranscriptViewportRow> => rowsFromProjectedMessages(snapshot.messages);
