...
export const sheetVariants = tv({
	base: "bg-background data-[state=open]:animate-in data-[state=closed]:animate-out fixed z-[var(--overlay-z)] flex flex-col gap-4 shadow-lg transition ease-in-out data-[state=closed]:duration-300 data-[state=open]:duration-500",
	variants: {
		side: {
...
<SheetPortal {...portalProps}>
	...
	>
		...
		>
			<HugeiconsIcon name="close" class="size-4" />
