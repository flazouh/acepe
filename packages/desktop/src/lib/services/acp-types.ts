...
export type ResolvedCapabilities = { status: ResolvedCapabilityStatus; availableModels: AvailableModel[]; currentModelId: string | null; modelsDisplay: ModelsForDisplay; providerMetadata: FrontendProviderProjection | null; availableModes: AvailableMode[]; currentModeId: string | null; configOptions: ConfigOptionData[] }
...
export type SessionStatePayload = { kind: "snapshot"; graph: SessionStateGraph } | { kind: "delta"; delta: SessionStateDelta } | { kind: "lifecycle"; lifecycle: SessionGraphLifecycle; revision: SessionGraphRevision } | { kind: "sessionMode"; currentModeId: string; revision: SessionGraphRevision } | { kind: "sessionModel"; currentModelId: string; revision: SessionGraphRevision } | { kind: "sessionModels"; availableModels: AvailableModel[]; revision: SessionGraphRevision } | { kind: "sessionConfigOption"; configId: string; value: string; revision: SessionGraphRevision } | { kind: "sessionArchive"; archivedAtMs: number | null } | { kind: "telemetry"; telemetry: UsageTelemetryData; revision: SessionGraphRevision } | { kind: "plan"; plan: PlanData; revision: SessionGraphRevision } | { kind: "viewportBufferPush"; push: ViewportBufferPush } | { kind: "viewportBufferDelta"; delta: ViewportBufferDelta }
