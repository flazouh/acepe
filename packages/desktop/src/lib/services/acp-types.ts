...
export type SessionStateDelta = { fromRevision: SessionGraphRevision; toRevision: SessionGraphRevision; transcriptDelta?: TranscriptDelta | null; changedFields?: string[] }
