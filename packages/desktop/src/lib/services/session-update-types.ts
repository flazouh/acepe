 ...
 */
export type UsageTelemetryTokens = {
	total?: number | null;
	input?: number | null;
	output?: number | null;
 ...
 */
export type UsageTelemetryData = {
	sessionId: string;
	eventId?: string | null;
	/**
...
export type SessionCompactionEvent = {
	...
	precomputed?: boolean | null;
	preservedMessageCount?: number | null;
...
export type SessionUpdate =
	...
	| {
			...
			produced_at_monotonic_ms?: number | null;
	  }
	| {
	...
	| { type: "toolCall"; tool_call: ToolCallData; session_id?: string | null }
	| { type: "toolCallUpdate"; update: ToolCallUpdateData; session_id?: string | null }
	| { type: "plan"; plan: PlanData; session_id?: string | null }
	| { type: "availableCommandsUpdate"; update: AvailableCommandsData; session_id?: string | null }
	| { type: "currentModeUpdate"; update: CurrentModeData; session_id?: string | null }
	| { type: "configOptionUpdate"; update: ConfigOptionUpdateData; session_id?: string | null }
	| { type: "permissionRequest"; permission: PermissionData; session_id?: string | null }
	| { type: "questionRequest"; question: QuestionData; session_id?: string | null }
	/**
	...
	| {
			...
			config_options?: ConfigOptionData[] | null;
...
export type ToolCallData = {
	...
	diagnosticRawInput?: JsonValue | null;
 ...
 */
export type ToolSourceContext = {
	path?: string | null;
	viewRange?: ToolSourceRange | null;
	/**
...
export type ToolArguments =
	| { kind: "read"; file_path?: string | null; source_context?: ToolSourceContext | null }
	| { kind: "readLints"; raw: JsonValue }
	/**
	 * Edit tool arguments.
	 *
	 ...
	 */
	| { kind: "edit"; edits: EditEntry[] }
	| { kind: "execute"; command?: string | null }
	| { kind: "shellInput"; shell_id?: string | null; input?: string | null }
	| { kind: "search"; query?: string | null; file_path?: string | null }
	| { kind: "glob"; pattern?: string | null; path?: string | null }
	| { kind: "fetch"; url?: string | null }
	| { kind: "webSearch"; query?: string | null }
	| {
			kind: "think";
	...
	| { kind: "taskOutput"; task_id?: string | null; timeout?: number | null }
	| { kind: "move"; from?: string | null; to?: string | null }
	| { kind: "delete"; file_path?: string | null; file_paths?: string[] | null }
	| {
			kind: "planMode";
			mode?: string | null;
			plan?: string | null;
	...
	| { kind: "toolSearch"; query?: string | null; max_results?: number | null }
	| {
			kind: "browser";
			raw: JsonValue;
			action?: string | null;
	...
	| { kind: "sql"; query?: string | null; description?: string | null }
	| {
			kind: "unclassified";
			provider_name: string;
			provider_kind_hint?: string | null;
			title?: string | null;
			arguments_preview?: string | null;
			signals_tried: string[];
	  }
	| { kind: "other"; raw: JsonValue; intent?: string | null };
...
export type PermissionData = {
	...
	replyHandler?: InteractionReplyHandler | null;
	permission: string;
	patterns: string[];
	metadata: JsonValue;
	always: string[];
 ...
 */
export type TurnErrorInfo = {
	message: string;
	kind: TurnErrorKind;
	code?: string | null;
	source?: TurnErrorSource | null;
	details?: string | null;
};
 ...
 */
export type StoredErrorMessage = {
	content: string;
	code?: string | null;
	details?: string | null;
	kind: TurnErrorKind;
