			...
			<Tooltip.Trigger>
				{#snippet child({ props })}
					<button
						...
						type="button"
						onclick={handleClick}
						class="inline-flex h-7 items-center gap-1.5 px-3 text-muted-foreground transition-colors hover:bg-accent hover:text-foreground focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring/50 focus-visible:ring-inset"
