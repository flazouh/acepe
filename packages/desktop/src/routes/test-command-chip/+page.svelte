...
import LiveSignInCardsFixture from "$lib/acp/components/agent-panel/components/live-sign-in-cards-fixture.svelte";
...
<div class="h-screen w-screen space-y-4 overflow-auto bg-background p-4">
	...
	<!--
		...
		sign-in method per agent -- whether an agent gets a control at all is a
		backend fact, and a static fixture cannot show that the fact travelled.
	-->
	<LiveSignInCardsFixture />
	<div
