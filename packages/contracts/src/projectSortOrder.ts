...
/**
 * A project's place in the sidebar, as a dense integer rank: the first project
 * is 0, the next 1, and so on with no gaps.
 *
 * A move rewrites the rank of every project whose position changed, so the
 * ranks stay dense and the next move can read them straight back. Sparse ranks
