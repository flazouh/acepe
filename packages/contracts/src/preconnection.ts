...
export const ProjectedPreconnectionOptions = Schema.Struct({
	sequence: Sequence,
	projectId: ProjectId,
	providerId: TrimmedNonEmptyString,
	options: Schema.Array(ConfigOptionData),
})
export type ProjectedPreconnectionOptions = typeof ProjectedPreconnectionOptions.Type

export const emptyProjectedPreconnectionOptions = (
	projectId: ProjectId,
	sequence: Sequence,
	providerId: TrimmedNonEmptyString,
