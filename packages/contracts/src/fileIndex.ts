...
export const GetProjectIndexRequest = Schema.Struct({
	projectPath: TrimmedNonEmptyString,
})
export type GetProjectIndexRequest = typeof GetProjectIndexRequest.Type

export const InvalidateProjectIndexRequest = Schema.Struct({
	projectPath: TrimmedNonEmptyString,
})
export type InvalidateProjectIndexRequest = typeof InvalidateProjectIndexRequest.Type
