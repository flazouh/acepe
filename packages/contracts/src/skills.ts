...
export const SkillsCatalog = Schema.Struct({
	agents: Schema.Array(SkillAgent),
	agentSkills: Schema.Array(AgentSkills),
	plugins: Schema.Array(PluginInfo),
	pluginSkills: Schema.Array(PluginSkill),
	tree: Schema.Array(SkillTreeNode),
})
export type SkillsCatalog = typeof SkillsCatalog.Type

export const ProjectedSkillsCatalog = Schema.Struct({
	sequence: Sequence,
	agents: Schema.Array(SkillAgent),
	agentSkills: Schema.Array(AgentSkills),
	plugins: Schema.Array(PluginInfo),
...
export type ProjectedSkillsCatalog = typeof ProjectedSkillsCatalog.Type

export const APP_SKILLS_ID: SkillsId = SkillsId.make("app")

export const emptySkillsCatalog: SkillsCatalog = {
	agents: [],
	agentSkills: [],
	plugins: [],
	pluginSkills: [],
