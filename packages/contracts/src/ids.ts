...
export const SkillsId = entityId("SkillsId")
export type SkillsId = typeof SkillsId.Type
export const decodeSkillsId = Schema.decodeUnknownEffect(SkillsId)

export const VoiceId = entityId("VoiceId")
