...
export const evolveProjectedCheckpoint = (
	...
	Match.type<OrchestrationEvent>().pipe(
		Match.discriminatorsExhaustive("type")({
			...
			VoiceAmplitudeObserved: () => ignoreEvent(current),
			VoiceModelDownloadProgressed: () => ignoreEvent(current),
...
export const checkpointIdFromEvent = (event: OrchestrationEvent): Option.Option<CheckpointId> =>
	Match.type<OrchestrationEvent>().pipe(
		Match.discriminatorsExhaustive("type")({
			...
			ThoughtAppended: () => Option.none(),
			TurnCancelled: () => Option.none(),
			TurnCompleted: () => Option.none(),
			...
			CheckpointFileReverted: (reverted) => Option.some(reverted.payload.checkpointId),
			...
			VoiceAmplitudeObserved: () => Option.none(),
			VoiceModelDownloadProgressed: () => Option.none(),
