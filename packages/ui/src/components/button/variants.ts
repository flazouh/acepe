	...
	compoundVariants: [
		{
			...
			active: false,
			class:
				"text-muted-foreground/45 hover:text-foreground focus-visible:text-foreground [&_svg]:text-muted-foreground/45 [&_svg]:transition-colors hover:[&_svg]:text-foreground focus-visible:[&_svg]:text-foreground",
		},
		{
			variant: "ghost",
			active: true,
