...
<AgentToolCard class={className} dataTestid="command-output-card">
	{#if hasModelDisplay}
		<div class="flex items-center gap-2 px-2 py-2 text-xs">
			<HugeiconsIcon name="sliders" class="h-3.5 w-3.5 shrink-0 text-muted-foreground" />
			<span class="text-muted-foreground">Model</span>
			<HugeiconsIcon name="arrow-left" class="h-3 w-3 shrink-0 rotate-180 text-muted-foreground/50" />
