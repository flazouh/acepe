...
import { spiralInwardNormFromIndex, spiralInwardOrderValue } from "../dotmatrix-core.js";
...
function createAnimationResolver(runtime: DotmatrixLoaderRuntime): DotAnimationResolver {
  ...
  const style = { "--dmx-spiral-order": order } as DmxStyleProperties;
...
export const dotm_square_3_config: DotmatrixLoaderConfig = {
  id: "dotm-square-3",
  defaultSpeed: 1.35,
  defaultPattern: "full",
  defaultSize: 36,
