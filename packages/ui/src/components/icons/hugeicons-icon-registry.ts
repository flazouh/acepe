...
const iconByName = {
	...
	copy: Copy01Icon,
	"copy-id": Copy01Icon,
	"diff-backgrounds": PaintBucketIcon,
	"diff-bars": ChartNoAxesColumnIcon,
	"diff-classic": PlusMinusSquare01Icon,
	"diff-inline-character": CodeXmlIcon,
	"diff-inline-word": TextSelectIcon,
	"diff-layout-split": SplitIcon,
	"diff-line-numbers": TextNumberSignIcon,
	"diff-wrapping": TextWrapIcon,
	document: File01Icon,
	...
	"git-diff-unified": ViewAgendaIcon,
