...
const customEntries = {
	...
	refresh: {
		viewBox: "0 0 16 16",
		inner:
			'<g fill="currentColor"><path d="M12.5895 4.83613L11.23 6.19601C10.933 6.49201 11.143 7.00001 11.563 7.00001H15.138C15.398 7.00001 15.609 6.78901 15.609 6.52901V2.95401C15.609 2.53401 15.101 2.32401 14.804 2.62101L13.672 3.75328C12.3204 1.78973 10.0599 0.5 7.5 0.5C3.364 0.5 0 3.864 0 8C0 12.136 3.364 15.5 7.5 15.5C11.296 15.5 14.434 12.663 14.925 9H13.41C12.932 11.833 10.468 14 7.5 14C4.191 14 1.5 11.309 1.5 8C1.5 4.691 4.191 2 7.5 2C9.64738 2 11.5311 3.13503 12.5895 4.83613Z"/></g>',
	},
	hand: {
		viewBox: "0 0 20 20",
		inner:
			'<path d="M7.2 9.7V5.6a1.1 1.1 0 0 1 2.2 0v3.2M9.4 8.7V4.8a1.1 1.1 0 0 1 2.2 0v4M11.6 9V6a1.1 1.1 0 0 1 2.2 0v5.2c0 3.1-1.7 5.2-4.7 5.2H8c-1.4 0-2.4-.5-3.2-1.5L2.9 12a1.1 1.1 0 0 1 1.8-1.3l1.1 1.4V8.4a1.1 1.1 0 0 1 2.2 0v1.3" fill="none" stroke="currentColor" stroke-width="1.7" stroke-linecap="round" stroke-linejoin="round"></path>',
	},
	download: {
		viewBox: "0 0 24 24",
		inner:
			'<g fill="currentColor"><path fill-rule="evenodd" clip-rule="evenodd" d="M16.969 10.059C17.262 9.766 17.737 9.766 18.03 10.059C18.323 10.352 18.323 10.827 18.03 11.12L12.15 17H11.35L5.46896 11.12C5.17596 10.827 5.17596 10.352 5.46896 10.059C5.76196 9.766 6.23696 9.766 6.52996 10.059L11 14.529V2.75C11 2.336 11.336 2 11.75 2C12.164 2 12.5 2.336 12.499 2.75V14.529L16.969 10.059ZM4.98193 19.7L5.78193 20.5H17.7169L18.5169 19.7V17.75C18.5169 17.336 18.8529 17 19.2669 17C19.6809 17 20.0169 17.336 20.0169 17.75V19.5C20.0169 20.881 18.8979 22 17.5169 22H5.98193C4.60093 22 3.48193 20.881 3.48193 19.5V17.75C3.48193 17.336 3.81793 17 4.23193 17C4.64593 17 4.98193 17.336 4.98193 17.75V19.7Z"/></g>',
	},
	"diff-backgrounds": {
		viewBox: "0 0 16 16",
		inner:
			'<g fill="none"><rect x="2.25" y="3" width="11.5" height="10" rx="2" stroke="currentColor" stroke-width="1.4"></rect><path d="M4.5 5.75H11.5" stroke="currentColor" stroke-width="1.3" stroke-linecap="round"></path><path d="M3.9 7.45H12.1V9.35H3.9V7.45Z" fill="currentColor" opacity=".28"></path><path d="M4.5 11H9.75" stroke="currentColor" stroke-width="1.3" stroke-linecap="round"></path></g>',
	},
	"diff-bars": {
		viewBox: "0 0 16 16",
		inner:
			'<g fill="none" stroke="currentColor" stroke-width="1.35" stroke-linecap="round"><path d="M3.5 3.6V6.7"></path><path d="M3.5 9.3V12.4"></path><path d="M6 4.25H12.5"></path><path d="M6 6.25H10.5"></path><path d="M6 9.75H12.5"></path><path d="M6 11.75H10.5"></path></g>',
	},
	"diff-classic": {
		viewBox: "0 0 16 16",
		inner:
			'<g fill="none" stroke="currentColor" stroke-width="1.3" stroke-linecap="round" stroke-linejoin="round"><rect x="2.5" y="2.75" width="11" height="10.5" rx="2.1"></rect><path d="M5.25 5.25V7.75"></path><path d="M4 6.5H6.5"></path><path d="M8.25 6.5H11.5"></path><path d="M4 10.2H6.5"></path><path d="M8.25 10.2H11.5"></path></g>',
	},
	"diff-line-numbers": {
		viewBox: "0 0 16 16",
		inner:
			'<g fill="none" stroke="currentColor" stroke-width="1.25" stroke-linecap="round" stroke-linejoin="round"><path d="M4.4 4.2V7.2"></path><path d="M3.7 4.9L4.4 4.2"></path><path d="M3.55 11.8H5.65"></path><path d="M3.65 9.45C3.85 8.9 4.37 8.6 4.9 8.67C5.45 8.74 5.85 9.12 5.85 9.62C5.85 10.09 5.58 10.4 5.12 10.74L3.65 11.8"></path><path d="M8.2 5.3H12.5"></path><path d="M8.2 8H11.5"></path><path d="M8.2 10.7H12.5"></path></g>',
	},
	"diff-wrapping": {
		viewBox: "0 0 16 16",
		inner:
			'<g fill="none" stroke="currentColor" stroke-width="1.35" stroke-linecap="round" stroke-linejoin="round"><path d="M3.25 4.5H12.75"></path><path d="M3.25 7.35H10.5C11.75 7.35 12.75 8.35 12.75 9.6C12.75 10.85 11.75 11.85 10.5 11.85H6.25"></path><path d="M7.75 10.35L6.25 11.85L7.75 13.35"></path></g>',
	},
};
...
const preferredAliases = {
	...
	"sidebar-open": "app-shell-bnrwydfu--02",
	"sidebar-closed": "app-shell-bnrwydfu--03",
	plus: "plus-d3dp-dmx",
...
function wrapInner(attributes, inner) {
	...
	if (
		/\bstroke-width=/.test(safeAttributes) &&
		!/\bstroke=/.test(safeAttributes)
	) {
...
for (const icon of manifest.icons) {
	iconNameCounts.set(
		icon.iconName,
		(iconNameCounts.get(icon.iconName) ?? 0) + 1,
	);
}
...
const aliasLines = aliasNames.map(
	(name) => `\t${quoted(name)}: ${quoted(aliases[name])},`,
);
