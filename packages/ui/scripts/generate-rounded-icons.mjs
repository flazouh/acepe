...
if (!sourceDir) {
	throw new Error(
		"Pass the Codex icon package path, for example: bun scripts/generate-rounded-icons.mjs /path/to/codex-icons",
	);
}
...
// Source: CodexNext packages/codex-icons (${sourceFiles.length} SVG files from ${basename(resolvedSourceDir)}).
