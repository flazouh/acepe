...
export const t3Comparison: ComparisonData = {
	...
	features: [
		...
		},
		{
			...
			competitor: 'Public repository code and tests include worktree-mode thread flows and `.t3/worktrees` paths',
		},
		{
			category: 'Safety',
			feature: 'Checkpoint history',
			acepe: 'Automatic snapshots after every tool run',
			competitor: 'Public repository code contains checkpoint tracking, checkpoint diffs, and projection flows',
		},
		{
			category: 'Platform',
		...
		},
		{
			...
			competitor: 'Not highlighted in the public README; repository code includes MCP-related UI paths but the product positioning stays intentionally minimal',
		},
	],
	differentiators: [
		{
	...
	faqs: [
		...
		},
		{
			...
			answer:
				'Yes. Acepe includes a built-in SQL editor and schema browser.',
		},
		{
