...
# deleted twice.
# Every lane gets its own app instance: socket, tracer DB and seed fixtures
# are all scoped by this key, so parallel lanes can DOM-verify concurrently.
export ELECTROBUN_QA_APP_ID="com.acepe.app.issue-${ISSUE}"
