...
If not installed, inform the user: "`agent-browser` is not installed. Run `agent-browser setup` to install required dependencies." Then stop — this skill cannot function without agent-browser.
...
If not installed, inform the user: "`agent-browser` is not installed. Run `agent-browser setup` to install required dependencies." Then stop.
