...
about 0.3 seconds through HMR, with no rebuild, no relaunch and no page reload.
Only Bun-side changes (`src/bun`, `@acepe/electrobun-shell`, `@acepe/server`)
need `electrobun:build`.
